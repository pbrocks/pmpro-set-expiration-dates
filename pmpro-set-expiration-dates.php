 ...
 * Plugin URI: https://www.paidmembershipspro.com/add-ons/pmpro-expiration-date/
 * Description: Set a specific expiration date (e.g. 2017-12-31) for a PMPro membership level or discount code.
 * Version: .4.1
 * Author: Stranger Studios
 * Author URI: http://www.strangerstudios.com
 */

include( 'inc/class-pmpro-expriration-dates-welcome.php' );
register_activation_hook( __FILE__, 'activate_expiration_dates_welcome_screen' );
function activate_expiration_dates_welcome_screen() {
